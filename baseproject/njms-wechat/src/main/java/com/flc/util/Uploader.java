...
public class Uploader {
	 ...
	 * 文件上传到指定的目录
	 */
	private static String UPLOAD_FOLDER_PATH = DbFH.getPprVueBypath("upload.properties").getProperty("upload.imagePath");
	/**
	 * 图片访问前缀
	 */
	private static String UPLOAD_REQUESTPATH = DbFH.getPprVueBypath("upload.properties").getProperty("upload.requestPath");
	...
	public void upload() throws Exception {
		...
		try {
			...
			String urlPath=UPLOAD_FOLDER_PATH+this.url;
