...
//设置文件在tomcat中路径
up.setUPLOAD_FOLDER_PATH(request.getRealPath("")+up.getUPLOAD_FOLDER_PATH());
System.out.println(up.getUPLOAD_FOLDER_PATH());
// 获取前端提交的path路径
...
//System.out.print("{'我是挂起':'"+currentPath+"','url':'"+up.getUrl()+"','title':'"+up.getTitle()+"','state':'"+up.getState()+"'}");
