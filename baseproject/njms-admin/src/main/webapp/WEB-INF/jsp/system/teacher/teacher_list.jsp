...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center" style="width:13.4%;">教师头像</th>
									<th class="center" style="width:13.4%;">姓名</th>
									<th class="center" style="width:13.4%;">课程类型</th>
									<th class="center" style="width:13.4%;">简介</th>
									<th class="center" style="width:13.4%;">从业年数</th>
									<th class="center" style="width:13.4%;">身份</th>
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${var.TEACHER_ID}" class="ace" /><span class="lbl"></span></label>
											</td>
											<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class='center'><img src='${var.HEADPORTRAIT}' onload="controlSize(this)" width="80px" height="40px;"/></td>
											<td class='center'>${var.NAME}</td>
											<td class='center'>${var.CURRICULUMTYPE}</td>
											<td class='center'>${var.INFO}</td>
											<td class='center'>${var.NUMBEROFYEARS}</td>
											<td class='center'>${var.IDENTITY}</td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.TEACHER_ID}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="del('${var.TEACHER_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.TEACHER_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.TEACHER_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			document.forms[0].action='<%=basePath%>teacher/excel.do';
			$("#Form").submit();
			document.forms[0].action="teacher/list.do";
		}
	</script>
